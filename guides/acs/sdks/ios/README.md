...
1. Drag the **Appcelerator.framework** folder from the **appcelerator-sdk-ios-1.0.0/** folder into your project's Frameworks folder, making sure **_Copy items into destination group's folder_** is checked, and click Finish.
...
6. Lastly, initialize Platform services by calling replacing **<< YOUR APP KEY >>** with the service key generated by Dashboard when you created your application.
