  * [Products](http://www.appcelerator.com/products)
...
study](http://www.appcelerator.com.s3.amazonaws.com/pdf/casestudy_nbc.pdf)
  ...
  * [Partners](http://www.appcelerator.com/partners)
    ...
    * [Technology Partners ](http://www.appcelerator.com/partners/technology-partners)

    * [Integration Partners ](http://www.appcelerator.com/partners/integration-partners)

    * [Overview](http://www.appcelerator.com/partners)

  * [Customers](http://www.appcelerator.com/customers)

    * [1-877-909-4589](tel:+18779094589)[Contact Sales](http://www.appcelerator.com/forms/pricing-standard)

    * [App Showcase](http://pinterest.com/appcelerator)

    * [Case Studies](http://thinkmobile.appcelerator.com/resource-center/?Tag=Case+Study)

    * [Testimonials](http://www.appcelerator.com/customers/testimonials)

    * [Overview](http://www.appcelerator.com/customers/)

  * [Company](http://www.appcelerator.com/company)

    * [Careers](http://www.appcelerator.com/company/jobs)

    * [Investors](http://www.appcelerator.com/company/investors)

    * [Board](http://www.appcelerator.com/company/board)

    * [Leadership](http://www.appcelerator.com/company/leadership)

    * [Blog ](http://thinkmobile.appcelerator.com/blog)

    * [Awards](http://www.appcelerator.com/company/awards)

    * [News](http://www.appcelerator.com/company/news)

    * [Overview](http://www.appcelerator.com/company)

  * [Contact](http://www.appcelerator.com/contact-us)

  *   * Getting Started
  * API Reference
  * SDKs
  * [Node.ACS](http://nodeacs.cloud.appcelerator.com/)

  * Access Control List
    * [Create an ACL](/docs/api/v1/acls/create)
    * [Update an ACL](/docs/api/v1/acls/update)
    * [Show an ACL](/docs/api/v1/acls/show)
    * [Delete an ACL](/docs/api/v1/acls/delete)
    * [Add user to ACL](/docs/api/v1/acls/add)
    * [Remove user from ACL](/docs/api/v1/acls/remove)
    * [Check user's permission of ACl](/docs/api/v1/acls/check)
  * Chats
    * [Create Chat Messages](/docs/api/v1/chats/create)
    * [Delete a Chat Message (Beta)](/docs/api/v1/chats/delete)
    * [Query Chat Messages](/docs/api/v1/chats/query)
    * [Chat Groups](/docs/api/v1/chats/chatgroup)
    * [Query Chat Groups](/docs/api/v1/chats/query_chatgroup)
  * Checkins
    * [Checkin to a Place or Event](/docs/api/v1/checkins/create)
    * [Query Checkins](/docs/api/v1/checkins/query)
    * [Show a Checkin](/docs/api/v1/checkins/show)
    * [Delete a Checkin](/docs/api/v1/checkins/delete)
  * Clients
    * [Geolocate a Client](/docs/api/v1/clients/geolocate)
  * Custom Objects
    * [Create Custom Object](/docs/api/v1/custom_objects/create)
    * [Show Custom Object(s)](/docs/api/v1/custom_objects/show)
    * [Update Custom Object](/docs/api/v1/custom_objects/update)
    * [Delete Custom Object(s)](/docs/api/v1/custom_objects/delete)
    * [Query Custom Objects](/docs/api/v1/custom_objects/query)
  * Emails
    * [Send Emails](/docs/api/v1/emails/send)
  * Events
  ...
  * Posts
    * [Create a Post](/docs/api/v1/posts/create)
...
![Btn-datafiles](/images/appcelerator/btns/btn-datafiles.png?1359678317)
...
## Access Control List(ACL): Show an ACL

### Summary

Show an ACL object with the given `id` or `name`.

**URL:** `GET https://api.cloud.appcelerator.com/v1/acls/show.json `
...
Example cURL request:
    ...
    $ curl -b cookies.txt -c cookies.txt "https://api.cloud.appcelerator.com/v1/acls/show.json?key=<YOUR APP APP KEY>&name;=access_photo_album"
